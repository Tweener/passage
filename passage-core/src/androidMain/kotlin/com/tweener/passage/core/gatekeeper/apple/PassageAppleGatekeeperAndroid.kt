 ...
 * @since 30/11/2024
 */
internal class PassageAppleGatekeeperAndroid<T : EntrantInterface> : PassageAppleGatekeeper<T>() {
     ...
     */
    override suspend fun signIn(params: Unit): Result<T> = suspendCatching {
        throw PassageGatekeeperNotImplementedException(
